    ...
    if is_ajax(request):
        ...
        if request.method == "POST":
            ...
            if not files_to_sign:
                return JsonResponse({'error': "Missing the 'files_to_sign' parameter."}, status=400)
            ...
            for file_to_sign in files_to_sign:
                ...
                if valid:
                    ...
                    file_to_sign['url'] = 'https://%s.s3.amazonaws.com/%s' % (S3_BUCKET, file_name)
