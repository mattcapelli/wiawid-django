...
class UserRegistrationView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            obj.key = key
            obj.save()
            send_email.delay(recipient_name=user.first_name, link=link, recipient_list=user.email, subject="Verify your WiaWid account", mail_for="sign-up", body=None)

            # Send email alert to app traffic
            to = 'matt@simpledatatools.com'
            subject = '[WiaWid] New Sign Up'
